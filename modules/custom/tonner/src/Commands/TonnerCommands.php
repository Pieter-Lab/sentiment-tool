...
class TonnerCommands extends DrushCommands {
  ...
  public $username = '3ffc4fa2-4f82-46f8-802f-406543717bf9';
  public $password = '1Sh7SC0boz1h';
  public $NLusername = '90bf4153-04d6-418f-bbd8-190855796b12';
  public $NLpassword = 'c7gLLyEHpifd';
  ...
  /**
   * Use Watson Natural Languae to extract Propper Nouns / Keyword from Text
   *
   * @usage tonner-nounsxtract
   *   Usage description
   *
   * @command tonner:nounsxtract
   * @aliases Nextract
   */
